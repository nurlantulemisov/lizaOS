...
void
timer_handler(REGISTERS *r) {
  uint32 i;
  TIMER_FUNC_ARGS *args = NULL;
  g_ticks++;
  // k_printf("timer triggered at frequency %d\n", g_ticks);
...
//         return;
//     }
//     index = (++g_timer_function_manager.current_index) %
//     MAXIMUM_TIMER_FUNCTIONS; g_timer_function_manager.current_index = index;
//     g_timer_function_manager.functions[index] = function;
//     memcpy(&g_timer_function_manager.func_args[index], args,
//     sizeof(TIMER_FUNC_ARGS));
// }
